            ...
            <Card className="rounded-3xl h-full transition-all duration-300 hover:-translate-y-2 hover:shadow-lg hover:shadow-teal-500/45">
              <CardContent className="p-6 flex flex-col h-full">
                ...
                <div className="mt-auto">
                  <a href={p.link} target="_blank" rel="noreferrer" className="group inline-flex items-center text-sm text-whie-600 transition-colors duration-300 hover:text-blue-800 dark:hover:text-blue-400">
                    View <ExternalLink className="w-4 h-4 ml-1 transition-transform duration-300 group-hover:translate-x-1" />
                  </a>
                </div>
              </CardContent>
            </Card>
